...
public class AgregateTest {
  String configName = "test/ru/nsu/ccfit/skokova/LinesOfCode/TestDirs/Testing1/config.txt";
  String dirName = "test/ru/nsu/ccfit/skokova/LinesOfCode/TestDirs/Testing1/";
  ...
  Assert.assertEquals(3, controller.getStatistics().getStat().get("&(.c >1400000000)").getFilesCount());
